...
//int t1=0,t2=0;
unsigned int sensors[8], lsavg[8]={700, 700, 700, 700, 700, 700, 700, 700},hsavg[8]={100, 100, 100, 100, 100, 100, 100, 100};
int sum=0;
int n=0;
...
void loop(){
  ...
  if(f==1){
    if(isDryRunComplete == false){
      ...
      f=0;
      Serial.println(path);
      Serial.println(simplify_path(path, 'R'));
    }
...
void dry_pid(){
  ...
  while(1){
    ...
    if(sensors[0]<hsavg[0]||sensors[7]<hsavg[7]){
      return;   
    }
